...
从 Round08 error layer 看，应该把“累计覆盖”和“阶段损失”分开读。
...
| Loss Layer | Lost Gold Evidence | Lost Gold Evidence % | Affected Claims | Affected Claim % | 解释 |
|---|---:|---:|---:|---:|---|
| not in top500 | 180 | 0.3666 | 91 | 0.5909 | 候选召回仍有上限 |
| top500 -> top50 | 58 | 0.1181 | 47 | 0.3052 | 需要扩大 scoring scope / fusion |
| top50 -> top20 | 52 | 0.1059 | 38 | 0.2468 | feature fusion 有帮助 |
| top20 -> top3 | 108 | 0.2200 | 71 | 0.4610 | final selection 是主要难点 |
