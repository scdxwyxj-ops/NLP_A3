...
The confusion matrix showed that the model performed best on the SUPPORTS class, while most classification errors occurred between SUPPORTS, REFUTES and NOT_ENOUGH_INFO. The DISPUTED class was the hardest to classify due to the smaller number of development examples and more ambiguous evidence relationships. 
