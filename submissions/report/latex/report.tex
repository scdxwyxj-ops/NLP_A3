...
0.5195, harmonic mean of 0.2910, and the classifier macro-F1 score of 0.4841. The
...
Prior work motivates each stage of this design.  FEVER formulates fact checking
as joint evidence retrieval and verdict prediction, and CLIMATE-FEVER shows that
climate claims add domain-specific retrieval challenges such as contested
framing, numerical comparisons, and temporal qualifications
\citep{thorne2018fever,diggelmann2020climatefever}.  Sparse retrieval methods
such as BM25 provide scalable high-recall candidate generation, while reciprocal
rank fusion combines heterogeneous lexical views without score calibration
\citep{robertson1994okapi,cormack2009rrf}.  Dense bi-encoders and sentence
embeddings improve semantic matching, and cross-encoders provide stronger
claim--evidence interaction for smaller candidate pools
\citep{karpukhin2020dpr,reimers2019sentence,nogueira2019bert}.  Evidence
aggregation and hybrid fact-checking work further suggests that passage
structure, lexical alignment, and shallow factual cues carry useful verification
signals beyond raw text concatenation
\citep{zhou2019gear,lee2018improving,padia2018umbc}.
...
classification accuracy of 0.5195, a harmonic mean score of 0.2910, and a
classifier macro-F1 score of 0.4841, as shown in Table~\ref{tab:final}.
...
Claim Classification Accuracy ($A$) & 0.5195 \\
Harmonic Mean of $F$ and $A$ ($H$) & 0.2910 \\
Top-3 Macro Recall & 0.2355 \\
Classifier Macro-F1 & 0.4841 \\
\bottomrule
\end{tabular}
...
claim accuracy 0.5195, harmonic mean 0.2910, and classifier macro-F1 0.4841.
